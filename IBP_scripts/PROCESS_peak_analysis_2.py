...
col2 = pl.cm.hsv(np.arange(365)/(365*1.0))
fig1, (ax1,ax2) = plt.subplots(2,1,sharex = True)
fig2, (ax3,ax4) = plt.subplots(2,1)
s = ["WLW1","WLW2","WLW3","WLW4","WLW5","WLW6","WLW7","WLW8","WLW9","WLW10"]
#s = ["WLW5"]
...
# =============================================================================
#     plt.figure()
#     plt.plot(df_w['d_depth_dt'])
#     plt.plot(df_w['peak'].iloc[df_w.peak.nonzero()]*0.02,'o')
#     plt.plot(df_w['depth_ave']*0.02)
# =============================================================================
    ...
    for peak_inds in tuples[0:-2]:
        drow = [sensor_id]
        snip = df_w[['run_time','depth_ave','d_depth_dt']].loc[peak_inds[0]:peak_inds[1]].copy()
        y_0 = snip.depth_ave.reset_index(drop=True).iloc[0]
        y_peak = snip.depth_ave.loc[peak_inds[2]]
        ...
        x_peak = snip.run_time.loc[peak_inds[2]]
...
ps_nofit = df_peakstats[['sensor_id','x_0','y_0','x_peak','y_peak','x_max','x_ymx','y_max','y_min','y_rise','y_rang','x_rise','x_rang','x_day']].copy()
...
ps_nofit = ps_nofit[(ps_nofit != 0).all(1)].dropna()
